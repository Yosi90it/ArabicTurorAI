...
router.post('/chat', async (req: Request, res: Response) => {
  ...
  try {
    ...
    const systemPrompt = req.body.useFullTashkeel 
      ? 'أنت مساعد تعليم اللغة العربية المفيد ومعلم طبيعي. تحدث بطريقة ودودة وطبيعية باللغة العربية الفصحى مع تشكيل كامل. استخدم الحركات (الضمة والفتحة والكسرة والسكون والتنوين والشدة) لكل حرف. مثال: مَرْحَباً بِكَ فِي تَعَلُّمِ الْعَرَبِيَّةِ! كَيْفَ يُمْكِنُنِي مُسَاعَدَتُكَ الْيَوْمَ؟'
      : 'أنت مساعد تعليم اللغة العربية المفيد ومعلم طبيعي. تحدث بطريقة ودودة وطبيعية باللغة العربية الفصحى مع تشكيل كامل. استخدم الحركات (الضمة والفتحة والكسرة والسكون والتنوين والشدة) لكل حرف.';
