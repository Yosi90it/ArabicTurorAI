...
export default function OriginalFirstPage() {
  ...
  const arabicText = `كَيْفَ أَقْضِي يَوْمِي
    ...
    <Card className="w-full max-w-4xl mx-auto bg-white shadow-lg">
      <CardContent className="p-0">
        ...
        <div className="relative min-h-[800px] bg-white p-8" style={{ fontFamily: 'serif' }}>
          ...
          {/* Main Content */}
          <div className="text-right leading-loose text-lg font-arabic space-y-4" dir="rtl">
            {showArabicText ? (
              <ClickableText 
                text={tashkeelEnabled ? arabicText : arabicText.replace(/[\u064B-\u065F\u0670\u0640]/g, '')}
                className="text-lg font-arabic leading-loose text-black"
              />
            ) : (
              <div className="text-left text-gray-700 leading-relaxed" dir="ltr">
                {germanTranslation}
              </div>
            )}
          </div>
