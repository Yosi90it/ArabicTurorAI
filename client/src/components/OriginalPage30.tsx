...
export default function OriginalPage30() {
        ...
        <CardContent className="p-0">
          ...
          <div className="flex justify-between items-center p-4 border-b bg-gray-50">
            <h2 className="text-lg font-semibold text-gray-800">
              {strings.language === 'de' ? 'Seite 30 - Original Layout' : 'Page 30 - Original Layout'}
            </h2>
          ...
          <div 
            ...
            style={{ 
              fontFamily: 'serif',
              backgroundImage: 'url(/attached_assets/Al-Qir`atur.Rashida (1-2)-page-030_1753722636279.jpg)',
              ...
              <div className="max-w-2xl mx-auto">
                <div className="bg-white/95 backdrop-blur-sm rounded-lg shadow-lg p-8 border border-gray-200">
                  ...
                  <div className="text-center mb-8">
                    <span className="text-lg">(٣٠)</span>
                  </div>
                  ...
                  {/* Footnote like in original */}
                  <div className="text-center mt-8 pt-4 border-t border-gray-200">
                    <div className="text-sm text-gray-600" dir="rtl">
                      <span className="ml-2">(١)</span>
                      <span>مُبَكِّراً: مُسْرِعاً</span>
                    </div>
                  </div>
                </div>
              </div>
