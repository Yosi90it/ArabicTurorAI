...
export default function OriginalSecondPage() {
  ...
  // Arabic text from page 34 (second page)
  const arabicText = `وَأَدْرُسُ فِيهَا النَّحْوَ وَالصَّرْفَ وَالْبَلاَغَةَ وَالْفِقْهَ وَالْحَدِيثَ وَالتَّفْسِيرَ وَالتَّارِيخَ وَالْجُغْرَافِيَا وَالْحِسَابَ ، وَأَحْفَظُ الْقُرْآنَ الْكَرِيمَ وَالْمُتُونَ الْمُهِمَّةَ ، وَأَكْتُبُ الْخَطَّ الْعَرَبِيَّ وَأَتَعَلَّمُ الْلُّغَةَ الْإِنْجِلِيزِيَّةَ.

وَبَعْدَ انْتِهَاءِ الدُّرُوسِ أَرْجِعُ إِلَى الْبَيْتِ وَأَتَغَدَّى ، ثُمَّ أَسْتَرِيحُ قَلِيلاً ، ثُمَّ أُذَاكِرُ دُرُوسِي وَأَكْتُبُ الْوَاجِبَاتِ ، وَأَلْعَبُ مَعَ إِخْوَتِي فِي الْبُسْتَانِ.`;

  const germanTranslation = `Fortsetzung: Wie ich meinen Tag verbringe

Ich studiere dort Grammatik, Morphologie, Rhetorik, Jurisprudenz, Hadith-Wissenschaft, Koranexegese, Geschichte, Geographie und Mathematik. Ich memoriere den edlen Quran und wichtige Texte, schreibe arabische Kalligraphie und lerne die englische Sprache.

Nach dem Ende der Unterrichtsstunden kehre ich nach Hause zurück und esse zu Mittag, dann ruhe ich mich ein wenig aus, dann wiederhole ich meine Lektionen und schreibe die Hausaufgaben, und ich spiele mit meinen Geschwistern im Garten.`;
        ...
        <CardContent className="p-0">
          ...
          <div className="flex justify-between items-center p-4 border-b bg-gray-50">
            <h2 className="text-lg font-semibold text-gray-800">
              {strings.language === 'de' ? 'Seite 2 - Original Layout' : 'Page 2 - Original Layout'}
            </h2>
          ...
          <div 
            ...
            style={{ 
              fontFamily: 'serif',
              backgroundImage: 'url(/qiraatu-images/Al-Qir`atur.Rashida (1-2)-page-034.jpg)',
