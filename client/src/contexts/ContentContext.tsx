...
export function ContentProvider({ children }: { children: ReactNode }) {
  const [books, setBooks] = useState<Book[]>([
    {
      id: 1,
      title: "Al-Qir'atur Rashida - الجزء الأول والثاني",
      content: `<h1>القراءة الراشدة - الجزء الأول والثاني</h1>
      <h2>درس القراءة الأول</h2>
      ...
      <h2>درس القراءة الثاني</h2>
      <p>وأمي تتكلم معي كل ليلة عند المنام فتقص علي قصص الأنبياء وكنت أسمع هذه القصص بنشاط ورغبة وبدأت أذهب مع أبي إلى المسجد وأقوم</p><!-- pagebreak -->
      
      <h2>درس الحديقة</h2>
      <p>في حديقتنا أشجار كثيرة وورود جميلة وفي الحديقة طيور تغرد وتطير من شجرة إلى شجرة وفي وسط الحديقة نافورة ماء جميلة والماء يخرج منها عاليا ثم ينزل في الحوض</p><!-- pagebreak -->
      
      <h2>درس المدرسة</h2>
      <p>مدرستنا كبيرة وجميلة وفيها فصول كثيرة وفي كل فصل طلاب يدرسون وفي المدرسة مكتبة كبيرة فيها كتب كثيرة ومفيدة وفي المدرسة أيضا ملعب كبير نلعب فيه ونمارس الرياضة</p><!-- pagebreak -->
      
      <h2>درس البيت</h2>
      <p>بيتنا واسع ومريح وفيه غرف كثيرة وفي البيت حديقة صغيرة وفي الحديقة أشجار وورود وأحب بيتنا كثيرا وأحب أن ألعب في الحديقة مع إخوتي</p><!-- pagebreak -->
      
      <h2>درس السوق</h2>
      <p>ذهبت مع أمي إلى السوق لنشتري طعاما وفي السوق محلات كثيرة وفي المحلات أشياء كثيرة ومفيدة اشترينا خضروات وفواكه ولحما وسمكا ورجعنا إلى البيت</p><!-- pagebreak -->
      
      <h2>درس العائلة</h2>
      <p>والدي يعمل في المكتب كل يوم ووالدتي تعمل في البيت وأخي الكبير يدرس في الجامعة وأختي الصغيرة تلعب في الحديقة ونحن عائلة سعيدة ونحب بعضنا كثيرا</p><!-- pagebreak -->
      
      <h2>درس الطبيعة</h2>
      <p>في الربيع تتفتح الأزهار وتخضر الأشجار والطيور تغرد والجو جميل ونذهب إلى الحديقة العامة ونتمشى ونلعب ونستمتع بالطبيعة الجميلة</p><!-- pagebreak -->
      
      <h2>درس التعلم</h2>
      <p>أحب القراءة كثيرا وأقرأ كل يوم وأحب الكتب المفيدة والقصص الجميلة وأذهب إلى المكتبة وأستعير كتبا جديدة وأقرأها في وقت الفراغ</p><!-- pagebreak -->
      
      <h2>درس الدين</h2>
      <p>أصلي خمس مرات في اليوم وأقرأ القرآن الكريم وأدعو الله أن يوفقني في دراستي وأن يبارك في أهلي وأحب الخير للناس جميعا</p>`,
      level: "intermediate",
      icon: "📖"
    },
    {
