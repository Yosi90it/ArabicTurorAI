...
export function ContentProvider({ children }: { children: ReactNode }) {
  const [books, setBooks] = useState<Book[]>([
    ...
    {
      id: 3,
      title: "قصص الأنبياء - الجزء الثاني (Qasas Al-Anbiya Part 2)",
      content: `<h1>قصص الأنبياء - الجزء الثاني</h1>
      
      <h2>قصة موسى عليه السلام</h2>
      <p>هنا سيتم إضافة المحتوى من قبل المستخدم</p>
      
      <h2>قصة عيسى عليه السلام</h2>
      <p>هنا سيتم إضافة المحتوى من قبل المستخدم</p>
      
      <h2>قصص أخرى للأنبياء</h2>
      <p>هنا سيتم إضافة المحتوى من قبل المستخدم</p>`,
      level: "intermediate",
      icon: "🕌"
    },
