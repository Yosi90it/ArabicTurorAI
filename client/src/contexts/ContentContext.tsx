...
export function ContentProvider({ children }: { children: ReactNode }) {
  const [books, setBooks] = useState<Book[]>([
    ...
    {
      id: 2,
      title: "قصص الأنبياء (Qasas al-Anbiya) - قصة إبراهيم عليه السلام",
      content: `<h1>قصص الأنبياء - قصة إبراهيم عليه السلام</h1>
      
      <h2>من كسر الأصنام؟</h2>
      <p>قصة عن النبي إبراهيم عليه السلام وكيف دعا قومه إلى التوحيد</p>`,
      level: "intermediate",
      icon: "🕌"
    },
    {
